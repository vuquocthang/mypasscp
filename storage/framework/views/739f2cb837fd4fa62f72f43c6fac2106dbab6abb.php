...
<head>
    <meta charset="UTF-8" />
    <title>Page5s - <?php $__env->startSection('title'); ?> Trang Chủ <?php echo $__env->yieldSection(); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>front/zxp/css/style.css">
    <link rel="stylesheet" href="<?php echo e(asset('')); ?>front/zxp/css/responsive.css">
        ...
        <div class="container clearfix">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo e(url('')); ?>">
                    <img src="<?php echo e(asset('')); ?>logo/page5s.png" alt="Awesome Image"/>
                </a>
            </div>
            ...
            <div class="right-side-box">
                ...
                --><a href="<?php echo e(url('login')); ?>" class="rqa-btn">Đăng Nhập</a>
            </div><!-- /.right-side-box -->
        </div><!-- /.container -->
    </nav>
</header><!-- /.header -->
                ...
                <div class="container">
                    <div class="box valign-middle">
                        <div class="content text-center">
                            ...
                            <a href="<?php echo e(url('login')); ?>" class="banner-btn" data-animation="animated fadeInDown">Bắt Đầu</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="service-carousel-one owl-theme owl-carousel">
            <div class="item">
                <div class="single-service-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/service-1-1.jpg" alt="Awesome Image"/>
            ...
            <div class="item">
                <div class="single-service-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/service-1-2.jpg" alt="Awesome Image"/>
                        <a href="#" class="read-more fas fa-link"></a>
                    </div><!-- /.img-box -->
                    <div class="content-box">
                        <div class="icon-box">
            ...
            <div class="item">
                <div class="single-service-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/service-1-3.jpg" alt="Awesome Image"/>
                        <a href="#" class="read-more fas fa-link"></a>
                    </div><!-- /.img-box -->
                    <div class="content-box">
                        <div class="icon-box">
            ...
            <div class="item">
                <div class="single-service-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/service-1-4.jpg" alt="Awesome Image"/>
                        <a href="#" class="read-more fas fa-link"></a>
                    </div><!-- /.img-box -->
                    <div class="content-box">
                        <div class="icon-box">
            ...
            <div class="item">
                <div class="single-service-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/service-1-5.jpg" alt="Awesome Image"/>
                        <a href="#" class="read-more fas fa-link"></a>
                    </div><!-- /.img-box -->
                    <div class="content-box">
                        <div class="icon-box">
            ...
            <div class="item">
                <div class="single-service-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/service-1-6.jpg" alt="Awesome Image"/>
                        <a href="#" class="read-more fas fa-link"></a>
                    </div><!-- /.img-box -->
                    <div class="content-box">
                        <div class="icon-box">
...
<section class="about-style-two">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <img src="<?php echo e(asset('')); ?>front/zxp/img/about-feature-1-1.jpg" class="pull-right" alt="Awesome Image"/>
            </div><!-- /.col-md-5 -->
            <div class="col-md-7">
                <div class="about-content">
                    ...
                    <div class="brand-logos">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/about-b-1-1.png" alt="Awesome Image"/>
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/about-b-1-2.png" alt="Awesome Image"/>
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/about-b-1-3.png" alt="Awesome Image"/>
                    </div><!-- /.brand-logos -->
                </div><!-- /.about-content -->
            </div><!-- /.col-md-7 -->
        </div><!-- /.row -->
        ...
        <div class="row masonary-layout filter-layout" data-filter-class="filter">
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item construction oil">
                <div class="single-project-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/project-1-1.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item construction mechanical">
                <div class="single-project-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/project-1-2.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="projects.html" class="more-btn fas fa-link"></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item construction oil">
                <div class="single-project-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/project-1-3.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="projects.html" class="more-btn fas fa-link"></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item mechanical oil">
                <div class="single-project-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/project-1-4.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="projects.html" class="more-btn fas fa-link"></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item welding">
                <div class="single-project-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/project-1-5.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="projects.html" class="more-btn fas fa-link"></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item mechanical">
                <div class="single-project-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/project-1-6.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="projects.html" class="more-btn fas fa-link"></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item construction">
                <div class="single-project-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/project-1-7.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="projects.html" class="more-btn fas fa-link"></a>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 masonary-item single-filter-item welding">
                <div class="single-project-style-one">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/project-1-8.jpg" alt="Awesome Image"/>
                        <div class="overlay">
                            <div class="box">
                                <div class="content">
                                    <a href="projects.html" class="more-btn fas fa-link"></a>
            ...
            <div class="item">
                <div class="single-testimonial-style-one">
                    <div class="top-box">
                        ...
                        <div class="icon-box">
                            <img src="<?php echo e(asset('')); ?>front/zxp/img/testi-1-1.jpg" alt="Awesome Image"/>
                        </div><!-- /.icon-box -->
                        <div class="text-box">
            ...
            <div class="item">
                <div class="single-testimonial-style-one">
                    <div class="top-box">
                        <i class="qoute-icon zxp-icon-right-quote"></i>
                        <div class="icon-box">
                            <img src="<?php echo e(asset('')); ?>front/zxp/img/testi-1-2.jpg" alt="Awesome Image"/>
                        </div><!-- /.icon-box -->
                        <div class="text-box">
            ...
            <div class="item">
                <div class="single-testimonial-style-one">
                    <div class="top-box">
                        <i class="qoute-icon zxp-icon-right-quote"></i>
                        <div class="icon-box">
                            <img src="<?php echo e(asset('')); ?>front/zxp/img/testi-1-3.jpg" alt="Awesome Image"/>
                        </div><!-- /.icon-box -->
                        <div class="text-box">
                            <h3>Outstanding Quality</h3>
                            <div class="stars">
            ...
            <div class="item">
                <div class="single-testimonial-style-one">
                    <div class="top-box">
                        <i class="qoute-icon zxp-icon-right-quote"></i>
                        <div class="icon-box">
                            <img src="<?php echo e(asset('')); ?>front/zxp/img/testi-1-4.jpg" alt="Awesome Image"/>
                        </div><!-- /.icon-box -->
                        <div class="text-box">
                            <h3>Professional Handling</h3>
                            <div class="stars">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-blog-style-two">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/blog-1-1.jpg" alt="Awesome Image"/>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-blog-style-two">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/blog-1-2.jpg" alt="Awesome Image"/>
                        <a href="blog-details.html" class="read-more">Read Post</a>
                    </div><!-- /.img-box -->
                    <div class="text-box">
                        <div class="meta-info">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="single-blog-style-two">
                    <div class="img-box">
                        <img src="<?php echo e(asset('')); ?>front/zxp/img/blog-1-3.jpg" alt="Awesome Image"/>
                        <a href="blog-details.html" class="read-more">Read Post</a>
                    </div><!-- /.img-box -->
                    <div class="text-box">
                        <div class="meta-info">
            ...
            <div class="row ">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-widget about-widget">
                        <a href="index-2.html"><img src="<?php echo e(asset('')); ?>front/zxp/img/footer-logo-1-1.png" alt="Awesome Image"/></a>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="footer-widget recent-post-widget">
                        ...
                        <div class="single-recent-post">
                            <div class="img-box">
                                <img src="<?php echo e(asset('')); ?>front/zxp/img/footer-rp-1-1.jpg" alt="Awesome Image"/>
                            </div><!-- /.img-box -->
                            <div class="text-box">
                        ...
                        <div class="single-recent-post">
                            <div class="img-box">
                                <img src="<?php echo e(asset('')); ?>front/zxp/img/footer-rp-1-2.jpg" alt="Awesome Image"/>
                            </div><!-- /.img-box -->
                            <div class="text-box">
...
<script src="<?php echo e(asset('')); ?>front/zxp/js/jquery.js"></script>

<script src="<?php echo e(asset('')); ?>front/zxp/js/bootstrap.min.js"></script>
<script src="<?php echo e(asset('')); ?>front/zxp/js/bootstrap-select.min.js"></script>
<script src="<?php echo e(asset('')); ?>front/zxp/js/jquery.validate.min.js"></script>
<script src="<?php echo e(asset('')); ?>front/zxp/js/owl.carousel.min.js"></script>
<script src="<?php echo e(asset('')); ?>front/zxp/js/isotope.js"></script>
<script src="<?php echo e(asset('')); ?>front/zxp/js/jquery.magnific-popup.min.js"></script>
<script src="<?php echo e(asset('')); ?>front/zxp/js/waypoints.min.js"></script>
<script src="<?php echo e(asset('')); ?>front/zxp/js/jquery.counterup.min.js"></script>
<script src="<?php echo e(asset('')); ?>front/zxp/js/wow.min.js"></script>
<script src="<?php echo e(asset('')); ?>front/zxp/js/jquery.easing.min.js"></script>
<script src="<?php echo e(asset('')); ?>front/zxp/js/custom.js"></script>
